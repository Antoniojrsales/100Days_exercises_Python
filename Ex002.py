# Create a program what read the name of one peaple and show one message of welcome

# Define a function called 'mensagem' what receive one parameter called 'nome'
def mensagem(nome):
